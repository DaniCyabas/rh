CREATE TABLE WKSP_WSFDC.RH_DES_AUTOMATICOS
 (
...
COMMENT ON TABLE WKSP_WSFDC.RH_DES_AUTOMATICOS IS 'Descuentos Automaticos a Empleados';
-- Grant/Revoke object privileges
grant select, insert, update, delete on WKSP_WSFDC.RH_DES_AUTOMATICOS to PUBLIC;
