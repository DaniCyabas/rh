CREATE OR REPLACE TRIGGER WKSP_WSFDC.AA_RH_PER_PREAVISO
...
BEGIN
  v_registro.tabla := 'RH_PER_PREAVISO';
  ...
  v_registro.detalle := v_registro.detalle || pae_cnf.fu_reg_auditoria( v_registro.tip_novedad, 'DIAS_PREAVISO', :old.dias_preaviso, :new.dias_preaviso, 'N' );
